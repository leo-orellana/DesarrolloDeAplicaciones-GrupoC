...
public class TestTransaction extends TestCase {
	...
	public void testConstructor() {
		...
		assertEquals(mockOperationCashAccount, transaction.getOperationCashAccount());
		assertEquals(mockOperationCheckingAccount, transaction.getOperationCheckingAccount());
		assertEquals(mockOperationBankAccount, transaction.getOperationBankAccount());
