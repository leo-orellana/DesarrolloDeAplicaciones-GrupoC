...
import ar.edu.unq.desapp.grupoc.BankOperation;
import ar.edu.unq.desapp.grupoc.Movement;
import ar.edu.unq.desapp.grupoc.OperationBankAccount;
...
public class BuilderOperationBankAccount {
	...
	public BuilderOperationBankAccount withBankOperation(BankOperation bankOperation)
	{
	...
	{
		return new OperationBankAccount(getMovement(), getAmount(), getBankOperation());
	}
